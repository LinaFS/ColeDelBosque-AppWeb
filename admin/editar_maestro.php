...
<head>
    ...
    <title>Editar Maestros - Colegio del bosque</title>
</head>
<body>
    <dialog id="warning">
    ...
    <main>
        <div class="panelTitle">
            <h1>Estás en la sección de maestros</h1>
            <h2>Editar un maestro</h2>
        </div>
        <div class="alumni">
            <form class="alumniForm" action="../php/maestro_edit.php" method="post" id="editar">
                <p>Nombre</p>
                <input type="text" name="nombre" value="<?php echo htmlspecialchars($nombre) ?>">
                <p>Apellido Paterno</p>
                <input type="text" name="paterno" value="<?php echo htmlspecialchars($paterno) ?>">
                <p>Apellido Materno</p>
                <input type="text" name="materno" value="<?php echo htmlspecialchars($materno) ?>">
                <p>Grado asignado</p>
                ...
                <p>Matrícula</p>
                <input type="text" name="matricula" value="<?php echo htmlspecialchars($matricula) ?>">
                <input type="hidden" name="id_cuenta" value="<?php echo htmlspecialchars($id); ?>">
                <button type="button" onclick="modal('editar')">Modificar</button>
            </form>
        </div>
